...
the throughputs show a similiar trend.%, also limited by Internet bandwidth.
...
I/O throughput can finially achieve around 2700MB/s, which is about 20 times faster than one of direct I/O.% and also 0\%cache hit cases.
