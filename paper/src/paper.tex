...
\affiliate{Titech}{Tokyo Institute of Technology, Japan, Tokyo, Meguro, okayama 2-12-1}
...
\begin{keyword}
Supercomputer, Cloud, Burst buffer
\end{keyword}
...
%3
\input{3_burst_buffer}

\input{4_model}

\input{5_evaluation}

\input{5-5_related_work}
