...
Fig.~\ref{throughput TSUBAME} shows I/O throughput between TSUBAME V queue nodes and TSBUAME Lustre file system, we can see that the aggreate read and write throughput reach 6-8GB/s with 64 nodes, the same result also can be seen in [].
